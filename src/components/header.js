    ...
    <nav className="fixed w-full z-30 top-0 text-white">
      ...
      <div className="pl-4 flex items-center">
		...
		<div className="block lg:hidden pr-4">
			<button onClick={() => toggleExpansion(!isExpanded)} id="nav-toggle" className="flex items-center px-3 py-2 border rounded text-gray-500 border-gray-600 hover:text-gray-800 hover:border-teal-500 appearance-none focus:outline-none">
